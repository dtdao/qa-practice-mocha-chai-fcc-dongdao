...
suite('Functional Tests', function() {
  ...
  suite('Integration tests with chai-http', function() {
    ...
    suite('GET /hello?name=[name] => "hello [name]"', function(){
      ...
      test('Test GET /hello with your name',  function(done){ // Don't forget the callback...
         chai.request(server)             // 'server' is the Express App
          .get('/hello?name=Dong') /** <=== Put your name in the query **/ 
          .end(function(err, res){        // res is the response object
            ...
            assert.equal(res.status, 200);
             assert.equal(res.text, 'hello Dong', 'Response should be Dong'/** <==  Put your name here **/);
            done();   // Always call the 'done()' callback when finished.
          });
      });
      ...
      test('send {surname: "Colombo"}',  function(done){
       ...
       chai.request(server)
        ...
        .end(function(err, res){
          ...
          /** your tests here **/
          assert.equal(res.status, 200, "response status should be 200")
          assert.equal(res.type, 'application/json', 'Response should be a json'); 
      ...
      test('send {surname: "da Verrazzano"}', function(done) {
        ...
        chai.request(server)
          ...
          .end(function(err,res){
            ...
            assert.equal(res.body.name, 'Giovanni', 'res.body.name should be the same')
  ...
  Browser.site = 'https://phase-price.glitch.me'; 
    ...
    suite('"Famous Italian Explorers" form', function() {
      ...
      test('submit "surname" : "Colombo" - write your e2e test...', function(done) {
        ...
        browser
          ...
          .pressButton('submit', () => {
              //browser is part of zombie  == which is headless browser, such that it has no userinterface.
              browser.assert.success()
